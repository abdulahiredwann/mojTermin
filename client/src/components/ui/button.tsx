  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-sm text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Custom trades business variants
        primary: "bg-primary text-primary-foreground hover:bg-charcoal-light tracking-wide uppercase text-xs",
        "primary-outline": "border-2 border-primary text-primary hover:bg-primary hover:text-primary-foreground tracking-wide uppercase text-xs",
        subtle: "bg-secondary text-secondary-foreground hover:bg-muted tracking-wide",
      },
      size: {
