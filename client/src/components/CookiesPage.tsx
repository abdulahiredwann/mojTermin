    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="border-t border-[#dceee4] bg-white py-14 md:py-20">
        <div className="mx-auto max-w-6xl space-y-10 px-6 md:px-12">
          ...
          <div>
            <h2 className="text-2xl font-bold text-gray-900">Katere piškotke uporabljamo?</h2>
          ...
          <div>
            <h2 className="text-2xl font-bold text-gray-900">Kako onemogočiti piškotke?</h2>
